...
function fixcross_pracRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of fixcross_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function probe_resp_pracRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of probe_resp_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_actualRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_actualComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function probe_respRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of probe_respComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function break25RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of break25Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function break50RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of break50Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function break75RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of break75Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
